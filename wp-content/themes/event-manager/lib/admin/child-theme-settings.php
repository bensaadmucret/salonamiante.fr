...
class Event_Manager_Settings extends Genesis_Admin_Boxes {
	...
	function __construct() {
		...
		$default_settings = array(
			...
			'footer_left' => sprintf( __( 'Powered by <a href="%s">Showthemes</a> on the <a href="%s">Genesis Framework</a>', 'social-coup' ), 'http://www.showthemes.com', 'http://billerickson.net/go/genesis' ),
