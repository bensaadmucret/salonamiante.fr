...
class EF_Activation_License_Manager {
    ...
    public function __construct() {
        ...
        if (is_admin()) {
            ...
            require_once( CHILD_DIR . '/event-framework/lib/api/classes/class-cc-tk-key-api.php' );

            // Checks for software updatess
            require_once( CHILD_DIR . '/event-framework/lib/api/classes/class-cc-tk-plugin-update.php' );

            // Admin menu with the license key and license email form
            require_once( CHILD_DIR . '/event-framework/lib/api/admin/class-cc-tk-license-menu.php' );
    ...
    public function plugin_url() {
        ...
        return $this->plugin_url = get_stylesheet_directory_uri() . '/event-framework/lib/api/';
    }
    ...
    public function activation() {
        ...
        require_once( CHILD_DIR . '/event-framework/lib/api/classes/class-cc-tk-passwords.php' );
