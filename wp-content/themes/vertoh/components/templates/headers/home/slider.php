<section class="fullwidth site-slider">
    <div class="section-content">
        <a href="<?php echo $ef_options['ef_header_down_link']; ?>" class="slide-down jump-link"><i class="fa fa-chevron-down center"></i></a>
            ...
            <div class="carousel-inner">
                ...
                if (!empty($ef_options['ef_header_gallery'])) {
                    ...
                    foreach (explode(',', $ef_options['ef_header_gallery']) as $id) {
                        ?>
                        <div class="item<?php echo $i++ == 0 ? ' active' : ''; ?>" style="background-image: url(<?php echo wp_get_attachment_url($id); ?>);"></div>
                        <?php
                    }
                }
                ?>
