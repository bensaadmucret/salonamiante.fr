...
function lien_spa_marseille() {
ob_start();	
	$args = array(
			'post_type'    => 'marseille_cpt',
			'orderby' => 'title',
			'order'   => 'ASC',
			'posts_per_page' => -1,
	);
...
add_shortcode( 'lien_spa_marseille', 'lien_spa_marseille' );




function contenu_spa_marseille() { 
ob_start();
$args = array(
			'post_type'    => 'marseille_cpt',
			'orderby' => 'title',
...
add_shortcode( 'contenu_spa_marseille', 'contenu_spa_marseille' );